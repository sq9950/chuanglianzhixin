...
class AppointmentController extends ComController{
	...
	public function update() {
		...
		$data['contacts'] = I('post.contacts', '', 'trim');
		$data['department'] = I('post.department', '', 'trim');
		$data['email'] = I('post.email', '', 'trim');
		$data['addr'] = I('post.addr', '', 'trim');
		$data['deviceNum'] = I('post.deviceNum', 0, 'intval');
		$data['serverNum'] = I('post.serverNum', 0, 'intval');
		$data['systemNum'] = I('post.systemNum', 0, 'intval');
		$data['virtualNum'] = I('post.virtualNum', 0, 'intval');
		$data['product'] = I('post.product', '', 'trim');
