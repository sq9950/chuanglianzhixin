...
class JobController extends ComController{ 
	...
	public function insert(){
		...
		$data['number'] = I('post.number', '', 'trim');
		$data['workcompany'] = I('post.workcompany', '', 'trim');
		$data['department'] = I('post.department', '', 'trim');
		$data['workcity'] = I('post.workcity', '', 'trim');
		$data['education'] = I('post.education', '', 'trim');
		$data['other'] = I('post.other', '', 'trim');
		$data['content'] = I('post.content', '', 'htmlspecialchars');
		$data['Indexfirst'] = I('post.Indexfirst', 0, 'intval');
