...
/*适用于class
  $(".GrzqDiv").css({"top":300+"px"})
  $(".GrzqDiv").css({"left":370+"px"})
*/  
  document.getElementById(id).style.top=20+"px";    /*适用于id*/
  document.getElementById(id).style.left=20+"px";
...
function ScrollDiv(/*id,pScrollY*/){ 
	...
	$(".GrzqDiv").offset().top = parseInt($(".GrzqDiv").offset().top) + moveTop + "px";
