...
<div class="pageContent">
	<form method="post" action="/index.php/Admin/Cms/News/insert/navTabId/classID<?php echo ($classID); ?>/callbackType/closeCurrent" class="pageForm required-validate" enctype="multipart/form-data"
	...
	<div class="pageFormContent nowrap" layoutH="97">
		...
		<dl>
			<dt>标题：</dt>
			<dd><input type="text" class="required" style="width:350px" name="title"/></dd> 
		</dl>
		<dl>
			<dt>作者：</dt>
			<dd><input type="text" class="required" style="width:350px" name="author"/></dd> 
		</dl>
		

		<!-- <dl>
			<dt>副标题：</dt>
			<dd><input type="text" style="width:350px" name="subtitle"/></dd> 
		</dl> -->

		<!-- <dl>
			<dt>外链：</dt>
			<dd><input type="text" style="width:350px" name="outlinks"/></dd> 
		</dl>

		<dl>
			<dt>点击量：</dt>
			<dd><input type="text" style="width:350px" name="hits"/></dd> 
		</dl> -->

		<dl>
			<dt>简介：</dt>
			<dd><textarea name="Intro" cols="55" class="required" style="height:80px" rows="5"></textarea></dd> 
		</dl>
		...
		<dl>
			<dt>置顶：</dt>
			<dd>
				<input type="checkbox" onclick="if(this.checked){this.value=1;}else{this.value=0}"   name="Indexfirst"/>
			</dd>
		</dl>
		...
		<!-- <dl>
			<dt>发布日期：</dt>
			<dd>
				<input type="text" name="writetime" class="date" readonly="true" value="<?php echo (date('Y-m-d', $time)); ?>" />
			</dd>
		</dl> -->
		...
		<dl style="display:none">
			<dd><input type="text" class="required"  style="width:100%" value="<?php echo ($classID); ?>" name="classID"/>
			</dd>
			<dd><input type="text" class="required" style="width:100%" value="<?php echo ($language); ?>" name="language"></dd>
		</dl>
