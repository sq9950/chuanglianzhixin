...
<form id="pagerForm" action="/index.php/Admin/Cms/Cooperation" method="post">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="/index.php/Admin/Cms/Cooperation/index" method="post">
			<input type="hidden" name="pageNum" value="1" />
			<input type="hidden" name="formstatus" value="<?php echo ($formstatus); ?>" />
			<div class="searchBar">
		...
		<table class="list" width="100%" layoutH="116">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
						...
						<td>
							<?php if(($lie["canupdate"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><a class="edit" href="/index.php/Admin/Cms/Cooperation/edit/id/<?php echo ($vo['id']); ?>/navTabId/classID<?php echo ($classID); ?>" target="navTab"><span>编辑</span></a>&nbsp;&nbsp;<?php endif; ?>  
							<?php if(($lie["candel"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><a class="delete" href="/index.php/Admin/Cms/Cooperation/delete/id/<?php echo ($vo['id']); ?>/navTabId/classID<?php echo ($classID); ?>" target="ajaxTodo" title="你确定要删除吗？" ><span>删除</span></a><?php endif; ?>  
						</td>
